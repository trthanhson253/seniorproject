...
@section('content')
 ...
 <div class="page-title">
            <div class="title_left">
                 ...
                 <p style="font-weight: 10px;color:blue;">Home >> Student >> Edit </p>
            </div>
        </div>
        ...
        <div class="row" >
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="border-radius: 10px;" >
                    <div class="x_title" >
                        <h2 style="font-weight: bold;"><i class="fa fa-edit"></i> Edit Student </h2>
                    ...
                    <div class="x_content">
                        <!-- content starts here -->
                            ...
                            @endif
                            <form action="admin/students/edit/{{$student->id}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <div class="form-group">
                                    <label class="control-label col-md-4">Username:<span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-3">
                                        <input type="text" name="name" placeholder="Add Username" required="required" class="form-control col-md-7 col-xs-12" value="{{$student->name}}">
                                         @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" name="studentid" placeholder="Add Student ID" value="{{$student->student_id}}" required="required" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="email" name="email" placeholder="Add Email" required="required" class="form-control col-md-7 col-xs-12" value="{{$student->email}}">
                                         @if ($errors->has('email'))
                                            <span style="color:red;" >                   
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="phone" placeholder="Add Phone" required="required" class="form-control col-md-7 col-xs-12" value="{{$student->phone}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="address" placeholder="Add Address" required="required" class="form-control col-md-7 col-xs-12" value="{{$student->address}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="file" value="{!! old('image') !!}" style="height:44px; margin-top:10px;" name="image" class="form-control col-md-7 col-xs-12">
