...
@section('content')
 ...
 <div class="page-title">
            <div class="title_left">
                 ...
                 <p style="font-weight: 10px;color:blue;">Home >> User >> Add </p>
            </div>
        </div>
        ...
        <div class="row" >
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="border-radius: 10px;" >
                    <div class="x_title" >
                        <h2 style="font-weight: bold;"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Librarian </h2>
                    ...
                    <div class="x_content">
                        <!-- content starts here -->
                            ...
                            @endif
                            <form action="admin/user/add" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="email" name="email" placeholder="Add Email" required="email" class="form-control col-md-7 col-xs-12">
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <label class="radio-inline">
                                                <input name="level" value="2" type="radio"> Librarian
                                        </label>
                                        <label class="radio-inline">
