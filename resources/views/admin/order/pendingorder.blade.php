...
@section('content')        
 <div class="page-title">
            <div class="title_left">
               <p style="font-weight: 10px;color:blue;">Home >> Request >> Pending Order </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="border-radius: 10px;">
                    ...
                    <div class="x_title">
                        <h2 style="font-weight: bold;"><i class="fa fa-list" aria-hidden="true"></i> Pending Request List</h2>
                        ...
                        <div class="clearfix"></div>
                           <ul class="nav nav-pills">
                                ...
                                <li role="presentation" class="active"><a href="admin/order/pendingorder" ><i class="fa fa-plus-circle" aria-hidden="true"></i> Pending Request </a></li>
