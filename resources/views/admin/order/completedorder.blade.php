...
@section('content')        
 <div class="page-title">
            <div class="title_left">
               <p style="font-weight: 10px;color:blue;">Home >> Request >> Completed Request </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="border-radius: 10px;">
                    ...
                    <div class="x_title">
                        <h2 style="font-weight: bold;"><i class="fa fa-list" aria-hidden="true"></i> Completed Request List</h2>
                        ...
                        <div class="clearfix"></div>
                           <ul class="nav nav-pills">
                                ...
                                <li role="presentation" class="active"><a href="admin/order/completedorder" ><i class="fa fa-plus-circle" aria-hidden="true"></i> Completed Request </a></li>
                            ...
                            <tr>
                                ...
                                <td>{{$o->created_at}}</td>
                                 ...
                                 <td class="center"><a href="admin/order/detail/{{$o->id}}"><button type="submit" name="submit" class="btn btn-success"><i class="fa fa-search-plus" aria-hidden="true"></i></button></a></td>
                                  <td class="center"><a href="admin/order/delete/{{$o->id}}" onclick="return confirm('Do you really want to cancel this order ?');"><button type="submit" name="submit" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>    
