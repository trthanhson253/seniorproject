...
#header:after{
  content: "A librarian is offline now.Please come back later or email us.";
...
<body>
    <div id="header" role="heading"><img id="presence" src="frontpage/img/offline.png" alt="" width="20px"><h1 id="title">A LIBRARIAN IS ONLINE</h1></div>
    <div id="layout"><div id="recv" role="main" dir="ltr" aria-live="polite" style="background: #EBEBE4;">
    ...
    <div id="send" role="textbox" dir="ltr">
        ...
        <table>
            <tr>
                ...
                <input type="text" name="author" class="form-control" style="font-weight: bold;color:blue;" placeholder="Your Name here..." ng-model="messageText" required disabled="">
                </div></td>
            ...
            <tr>
                <td><div class="form-group">
                <input type="text" name="content" required class="form-control" placeholder="Type HERE to chat.Press ENTER to send..." ng-model="messageText" disabled>
            </div><td>
                </tr>
        </table>          
