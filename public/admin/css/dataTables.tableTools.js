...
TableTools.prototype = {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		 ...
		 */
		$(document).bind( "https://demo6.sourcecodefree.org/js/datatables/tools/js/keydown.DTTT", function(e) {
	...
	"_fnPrintEnd": function ( e )
	{
		...
		$(document).unbind( "https://demo6.sourcecodefree.org/js/datatables/tools/js/keydown.DTTT" );
	},
...
TableTools.BUTTONS = {
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		"sAjaxUrl": "https://demo6.sourcecodefree.org/xhr.php",
